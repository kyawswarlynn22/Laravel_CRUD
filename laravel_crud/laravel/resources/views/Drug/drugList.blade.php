    ...
    <div class="relative mt-3 overflow-x-auto w-full shadow-md sm:rounded-lg">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-4 justify-center text-right flex space-x-2">
                    <a href="/drug/{{ $drug->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="/drug/{{ $drug->id }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                   ...
                   <form action="/drug/{{ $drug->id }}" method="post">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg width="24" height="24" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
               ...
               @empty
                   <p class=" text-red-500"> No Drug</p>
               @endforelse

            </tbody>
        </table>
        <div class="p-5">
            {{ $drugList->links('pagination::tailwind') }}
        </div>
    </div>
@endsection
