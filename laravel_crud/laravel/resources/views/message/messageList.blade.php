...
<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
    ...
    <td class="px-6 py-4 text-right float-right flex space-x-2">
        <a href="/message/{{ $message->id }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg
                width="24" height="24" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <path fill="#3b82f6"
        ...
        <a href="/message/{{ $message->id }}/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg
...
@empty
    <p class="text-red-500">Not Message Empty</p>
@endforelse
            </tbody>
        </table>
        <div class=" p-5">
            {{ $messageData->links("pagination::tailwind") }}
        </div>
    </div>
