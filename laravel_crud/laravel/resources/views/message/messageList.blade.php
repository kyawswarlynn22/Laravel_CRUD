            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 text-right float-right flex space-x-2">
                        <a href="/message/1" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg
                        ...
                        <a href="/message/1/edit" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><svg
