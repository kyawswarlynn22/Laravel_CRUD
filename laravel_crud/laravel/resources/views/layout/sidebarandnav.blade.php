        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                ...
                <ul id="room" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="/room"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Room
                            List</a>
                    </li>
            ...
            <li>
                ...
                <ul id="drug" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="/drug"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Drug
                            List
                        </a>
                    </li>
                </ul>
            ...
            <li>
                ...
                <ul id="appointment" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="/appointment"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Appointment
                            List</a>
                    </li>
                </ul>
            </li>
